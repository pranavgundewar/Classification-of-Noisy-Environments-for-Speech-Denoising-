...
clean_paths={'F:\College Stuff\BE Project\Final\Audio Class Samples\Restaurant Noise\filtered_podcast1_restaurant2.m4a';...
    'F:\College Stuff\BE Project\Final\Audio Class Samples\Train Noise\filtered_podcast1_train4.m4a';...
    'F:\College Stuff\BE Project\Final\Audio Class Samples\Airport Noise\filtered_podcast1_airport2.m4a'};
% directory paths for the input files
% input_paths={'F:\BE Project\Filter\podcast+airport_noise_2min.m4a'};
input_paths={'F:\College Stuff\BE Project\Final\Audio Class Samples\Restaurant Noise\podcast1+restaurant_noise\podcast1+restaurant_noise2.m4a';...
    'F:\College Stuff\BE Project\Final\Audio Class Samples\Train Noise\podcast1+train_noise\podcast1+train_noise4.m4a';...
    'F:\College Stuff\BE Project\Final\Audio Class Samples\Airport Noise\podcast1+airport_noise\podcast1+airport_noise2.m4a'};
%%
...
for index= 1:len
  %Reading noisy file, reading corresponding clean file and enhanced file  
    ...
    for method=1:2
        ...
        % directory paths for the pure speech file
...
set(gca, 'XTick', 1:length(input_paths(1:3)), 'XTickLabel', input_paths(1:3))
