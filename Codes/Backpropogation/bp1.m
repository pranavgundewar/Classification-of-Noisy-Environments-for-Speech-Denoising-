...
w8=load('F:\College Stuff\BE Project\Final\Training and Testing MAT files\Train_MFCC_20to25min.mat');
w4=w1.MFCC13;
w5=w2.MFCC13;
w6=w3.MFCC13;
w9=w8.MFCC13;
X=[w4;w5;w6];
y=[ones(119993,1);2*ones(119993,1);3*ones(119996,1)];
y2=2*ones(29999,1);
m = size(X, 1);
...
pred2 = predict(Theta1, Theta2, w9);
